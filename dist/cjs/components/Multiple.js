...
require("./flx.multiple-upload.css");
...
var Multiple = function (_a) {
    ...
    var _g = (0, react_1.useState)([]), DataFile = _g[0], setDataFile = _g[1];
    var _h = (0, react_1.useState)(""), Highlight = _h[0], setHighlight = _h[1];
    var _j = (0, react_1.useState)(false), UploadResult = _j[0], setUploadResult = _j[1];
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all(Array.from(files).map(function (f) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                ...
                case 1:
                    ...
                    setDataFile(tslib_1.__spreadArray(tslib_1.__spreadArray([], DataFile, true), resultFilter, true));
                    _a.label = 2;
                case 2:
                    if (fileRef.current) {
    ...
    var onClick = function (e) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    resultFile = tslib_1.__spreadArray(tslib_1.__spreadArray([], DataFile, true), item, true);
    ...
    return (react_1.default.createElement("div", { className: "flx" },
        react_1.default.createElement("div", { "data-mu": "loader", style: { width: "".concat(width, "%") } }),
        react_1.default.createElement("div", { "data-mu": "container", onDragOver: function (e) { onDragOver(e); }, onDrop: function (e) { onDrop(e); } },
            (DataFile || []).map(function (d, x) {
                return (react_1.default.createElement("div", { "data-mu": "item", style: { backgroundImage: "url(".concat(d.blob, ")") }, key: "data-mu-item-".concat(x) },
                    react_1.default.createElement("div", { "data-mu": "item-close", className: 'active', onClick: function () { onDelete(d["id"]); } },
                        react_1.default.createElement(Svg_1.default, { icon: "close" })),
                    d["error"] === 0 &&
                        react_1.default.createElement("div", { "data-mu": "item-info", className: settings.imageInfo === true ? "active" : "" },
                            react_1.default.createElement("div", { "data-mu": "item-info-item" }, d["size"]),
                            react_1.default.createElement("div", { "data-mu": "item-info-item" }, d["type"]),
                            react_1.default.createElement("div", { "data-mu": "item-info-item" }, d["pixel"]),
                            react_1.default.createElement("div", { "data-mu": "item-info-item-icon", onClick: function () { setHighlight(d.blob); } },
                                react_1.default.createElement(Svg_1.default, { icon: "zoom" }))),
                    d["error"] === 1 &&
                        react_1.default.createElement("div", { "data-mu": "item-info-error" }, "Image Type Incorrect"),
                    d["error"] === 2 &&
                        react_1.default.createElement("div", { "data-mu": "item-info-error" }, "Image Pixel Incorrect"),
                    d["error"] === 3 &&
                        react_1.default.createElement("div", { "data-mu": "item-info-error" }, "Image Size Incorrect")));
            }),
            react_1.default.createElement("div", { "data-mu": "item-empty", onClick: function () { fileRef === null || fileRef === void 0 ? void 0 : fileRef.current.click(); } },
                react_1.default.createElement("div", null,
                    react_1.default.createElement("div", { "data-mu": "item-empty-icon", style: { textAlign: "center" } }, placeholder.icon),
                    react_1.default.createElement("div", { "data-mu": "item-empty-text", style: { textAlign: "center" } }, placeholder.text)),
                react_1.default.createElement("input", { ref: fileRef, type: "file", onChange: onClick, multiple: true, hidden: true }))),
        react_1.default.createElement("div", { "data-mu": "button-container" },
            react_1.default.createElement("div", { "data-mu": "button-body", className: api.ssr && DataFile.length > 0 ? "active" : "" },
                react_1.default.createElement("div", { "data-mu": "button", className: ErrorControl() === false ? "disabled" : "", onClick: function () { ErrorControl() === true && setUpload(true); } }, placeholder.button))),
        react_1.default.createElement("div", { "data-go": "highlight-container", className: Highlight !== "" ? "active" : "", onClick: function () { setHighlight(""); } },
            react_1.default.createElement("div", { "data-go": "highlight-body", className: Highlight !== "" ? "active" : "", style: { backgroundImage: "url(".concat(Highlight, ")") } },
                react_1.default.createElement("div", { "data-go": "highlight-close", onClick: function () { setHighlight(""); } },
                    react_1.default.createElement(Svg_1.default, { icon: "close" }))))));
};
